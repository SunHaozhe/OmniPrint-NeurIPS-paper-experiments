...
for seed in "14" "24" "51" "61" "71" "77" "81" "88"
do
    for DATA in "--src_domain MNIST_like_ --tgt_domain mnist_png_test" #"--src_domain meta3 --tgt_domain meta5" 
    do
