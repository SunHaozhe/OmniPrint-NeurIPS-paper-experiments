...
def main():
    ...
    project_name = "OmniPrint-{}-episodes_MAML".format(os.path.basename(args.dataset))
    ...
    for epoch in range(args.epochs):
        mtrain(dataloader, net, device, meta_opt, epoch, args.inner_steps, log, mval_period)
...
def mtrain(dataloader, net, device, meta_opt, epoch, inner_steps, log, mval_period):
    net.train()
