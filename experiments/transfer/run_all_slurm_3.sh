...
for seed in "51" "61" "71"
do
    for DATA in "--src_domain meta5 --tgt_domain meta3" "--src_domain meta3 --tgt_domain meta5" "--src_domain meta5 --tgt_domain meta4" "--src_domain meta4 --tgt_domain meta5" "--src_domain meta4 --tgt_domain meta3" "--src_domain meta3 --tgt_domain meta4"
    do
