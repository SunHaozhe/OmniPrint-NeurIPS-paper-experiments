...
def main():
    ...
    argparser.add_argument('--epochs', type=int, help='how many epochs in total', default=120)
    ...
    project_name = "OmniPrint-Z-{}_PretrainOnMtrain".format(os.path.basename(args.dataset))
